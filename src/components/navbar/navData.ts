// WebP variants generated by `npm run optimize:images` (~90% smaller than PNG/JPG).
import ledPosterNavImg from '@/assets/products/led-screen/poster/front.webp';
import ledScreenNavImg from '@/assets/products/led-screen/hero.webp';
import sportsNavImg from '@/assets/products/navbar/sports.webp';
import advertisingNavImg from '@/assets/products/navbar/advertising.webp';
import eventsNavImg from '@/assets/products/navbar/events.webp';
import virtualProductionNavImg from '@/assets/products/navbar/virtual-production.webp';
import corporateNavImg from '@/assets/products/navbar/corporate.webp';
    ...
    sections: [
      {
        title: 'Industries',
        items: [
          { title: 'Sports & Arenas', description: 'Stadium-grade LED solutions', href: '/market/sports', image: sportsNavImg },
          { title: 'Advertising & DOOH', description: 'High-impact digital out-of-home displays', href: '/market/advertising', image: advertisingNavImg },
          { title: 'Events & Staging', description: 'Touring and rental displays for live productions', href: '/market/events', image: eventsNavImg },
          { title: 'Virtual Production', description: 'XR-ready LED volumes for film and broadcast', href: '/market/virtual-production', image: virtualProductionNavImg },
          { title: 'Corporate & Control Rooms', description: 'Mission-critical visualization solutions', href: '/market/corporate', image: corporateNavImg },
        ],
      },
    ],
  },
