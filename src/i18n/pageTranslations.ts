...
const en: PageTranslations = {
  about: {
    ...
    heroSubtitle: 'A new brand, founded by industry veterans',
    heroDescription: 'VEXALED engineers full-spectrum LED display systems for architecture, entertainment, and beyond — backed by a team with 20+ years of combined LED expertise.',
    ...
    overview: {
      ...
      globalImpactDesc: 'Projects delivered to 50+ countries with engineering support, local partnerships, and responsive service.',
    },
    foundedNote: 'Launched in <strong>2026</strong> from Foshan, Guangdong, VEXALED brings together LED display veterans into a focused brand — offering full-spectrum display systems, control solutions, and professional services.',
    ...
    overviewPage: {
      ...
      tag: 'About VEXALED',
      description: 'A new brand in LED display technology, founded by industry veterans in Foshan, Guangdong.',
      longDescription: 'VEXALED engineers premium LED display systems for the world\'s most demanding environments — from concert stages and sports arenas to corporate boardrooms and retail flagships. Headquartered in Foshan, Guangdong, our team brings 20+ years of LED display engineering to every project.',
      specs: [
        { label: 'Founded', value: '2026' },
        { label: 'Headquarters', value: 'Foshan, Guangdong, China' },
